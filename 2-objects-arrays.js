...
for (let i = 0; i < stringArray.length; i = i + 2) {
  console.log(i);
}
...
let numb = [42, 65, 49, 68, 56, 47, 70, 42, 51, 35, 58, 63, 40, 70]
...
info.push({word: vegetables[i], length: vegetables[i].length});
} 

console.log(info);

for (let i = 0; i < info.length; i++) {
  console.log(info[i].word + " - " + info[i].length)
}
